...
export default function TestimonialSectionComponent() {
   ...
   return (
      <div className='pb-14 px-8 md:px-2'>
         ...
         <div className='grid grid-cols-auto gap-8 mt-14'>
            {dummyTestimonial.map((testimonial, index) => (
               ...
               >
                  <div className='flex items-center gap-3 px-5 py-4 bg-gray-500/10'>
                     ...
                     <div className='flex gap-0.5'>
                        {[...Array(5)].map((_, index) => (
                           <img
                              className='h-5'
                              key={index}
                              src={index < Math.floor(testimonial.rating) ? assets.star : assets.star_blank}
                              alt='star'
                           />
                        ))}
                     </div>
