...
export default function EnrollmentsPage() {
   ...
   const { userData, enrolledCourses, fetchUserEnrolledCourses, navigate, backendURL, getToken, calculateCourseDuration, calculateNumberOfLectures } = useContext(AppContext);

   /**
    * getCourseProgress - fetches the course progress
