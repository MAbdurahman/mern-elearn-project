...
import RatingComponent from '../../components/student/RatingComponent.jsx';
...
export default function PlayerPage({}) {
   ...
   const { enrolledCourses, backendURL, getToken, calculateChapterTime, userData,
      fetchUserEnrolledCourses } = useContext(AppContext);

   /**
    * getCourseData - This function is used to get the course data from the enrolled courses
    */
   ...
   /**
    * handleToggleSection - toggles the section open or closed
    * @param index
    */
   ...
   /**
    * getCourseProgress - This function is used to get the course progress
   ...
   /**
    * handleAddRating - This function is used to add a rating to the course
    * @param rating
    * @returns {Promise<void>}
    */
   ...
   /**
    * handleMarkLectureAsCompleted - This function is used to mark a lecture as completed
    * @param lectureId
    * @returns {Promise<void>}
    */
   async function handleMarkLectureAsCompleted(lectureId) {
      try {
         ...
         <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36' >
            <div className=" text-gray-800" >
               ...
               <div className=" flex items-center gap-2 py-3 mt-10">
                  ...
                  <RatingComponent initialRating={initialRating} onRate={handleAddRating} />
               </div>
                     ...
                     ? (
                        <div>
                           ...
                           <div className='flex justify-between items-center mt-1'>
                              ...
                              <button onClick={() => handleMarkLectureAsCompleted(playerData.lectureId)} className='text-blue-600'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Completed' : 'Mark Complete'}</button>
                           </div>
                        </div>
                     )
